...
import com.ppy.nfclib.util.MiUtil.PermissionResult.Companion.PERMISSION_ASK
import com.ppy.nfclib.util.MiUtil.PermissionResult.Companion.PERMISSION_DENIED
import com.ppy.nfclib.util.MiUtil.PermissionResult.Companion.PERMISSION_GRANTED
import com.ppy.nfclib.util.MiUtil.PermissionResult.Companion.PERMISSION_UNKNOWN
...
object MiUtil {
    ...
    fun intentToAppSetting(context: Context): Boolean {
        ...
        return try {
            ...
            Logger.get().println("open app setting fail ${e.message}", e)
            false
        }
    }
}